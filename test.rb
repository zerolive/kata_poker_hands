...
class HighCard < PokerHands
	class << self
		...
		def build *hands
			highblackcard = high_card(*translate_ranks_to_values(*player_hand("black", "ranks", *hands)))
			highwhitekcard = high_card(*translate_ranks_to_values(*player_hand("white", "ranks", *hands)))
